...
export function Header() {
    // // Estado: são variáveis monitoradas pelo React. Toda vez que uma variável que for um estado mudar de valor o React recalcula o HTML
    ...
    return (
        ...
        <div className='w-full max-w-3xl mx-auto flex items-center justify-between'>
            ...
            {/* Fazer o modal utilizando a biblioteca Radix UI */}
            <Dialog.Root>
                <Dialog.Trigger
                type='button'
