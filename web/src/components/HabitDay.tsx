...
// Estiliza a barra de progresso dos hábitos diários com base nos dados do backend
...
export function HabitDay({ defaultCompleted = 0, amount = 0, date} : HabitDayProps){
    ...
    // Barra de progresso atualizar conforme os hábitos forem sendo marcados ou desmarcados
...
//Todas as medidas no Tailwind são multiplas de 4